Feature: frontmatter defaults
  Scenario: Use default for frontmatter variables internally
    ...
    And I have an "index.php" page with title "some title" that contains "just some page"
    ...
    And I should see "THIS IS THE LAYOUT: just some page" in "_site/index.php"
  ...
  Scenario: Use default for frontmatter variables in Liquid
    ...
    And I have an "index.php" page that contains "just {{page.custom}} by {{page.author}}"
    ...
    And I should see "just some special data by Ben" in "_site/index.php"
  ...
  Scenario: Override frontmatter defaults by path
    ...
    And I have an "index.php" page with title "overview" that contains "Overview for {{page.description}}"
    And I have an "special/index.php" page with title "section overview" that contains "Overview for {{page.description}}"
    ...
    When I run jekyll build
    Then the _site directory should exist
    And I should see "root: <p>info on the webpage</p>" in "_site/2013/10/14/about.php"
    And I should see "subfolder: <p>info on the special section</p>" in "_site/special/2013/10/14/about.php"
    And I should see "root: Overview for the webpage" in "_site/index.php"
    And I should see "subfolder: Overview for the special section" in "_site/special/index.php"
  ...
  Scenario: Use frontmatter variables by relative path
    ...
    And I have the following post:
      | title | date       | content                               |
      | about | 2013-10-14 | content of site/2013/10/14/about.php |
    And I have a special/_posts directory
    And I have the following post in "special":
      | title  | date       | path  | content                                        |
    ...
    When I run jekyll build
    Then the _site directory should exist
    And I should see "main: <p>content of site/2013/10/14/about.php</p>" in "_site/2013/10/14/about.php"
  ...
  Scenario: Override frontmatter defaults by type
    ...
    And I have an "index.php" page that contains "interesting stuff"
  ...
  Scenario: Actual frontmatter overrides defaults
    ...
    And I have an "index.php" page with permalink "override.html" that contains "nothing"
  ...
  Scenario: Define permalink default for posts
    ...
    When I run jekyll build
    Then I should see "blabla" in "_site/blog/testpost/index.php"

  Scenario: Use frontmatter defaults in collections
    Given I have a _slides directory
    And I have a "index.php" file that contains "nothing"
  ...
  Scenario: Deep merge frontmatter defaults
    Given I have an "index.php" page with fruit "{orange: 1}" that contains "Fruits: {{ page.fruit.orange | plus: page.fruit.apple }}"
    And I have a configuration file with "defaults" set to "[{scope: {path: ""}, values: {fruit: {apple: 2}}}]"
    When I run jekyll build
    Then I should see "Fruits: 3" in "_site/index.php"
