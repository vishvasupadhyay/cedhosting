Feature: Include tags
  ...
  Scenario: Include a file from a variable
    ...
    And I have an "index.php" page that contains "{% include {{site.include_file1}} %} that {% include {{site.include_file2}} what='parameters' %}"
    When I run jekyll build
    Then the _site directory should exist
    And I should see "a snippet that works with parameters" in "_site/index.php"
  ...
  Scenario: Include a variable file in a loop
    ...
    And I have an "index.php" page with files "[one.html, two.html]" that contains "{% for file in page.files %}{% include {{file}} %} {% endfor %}"
    When I run jekyll build
    Then the _site directory should exist
    And I should see "one two" in "_site/index.php"
  ...
  Scenario: Include a file with variables and filters
    ...
    | key          | value |
    | include_file | one   |
    And I have an "index.php" page that contains "{% include {{ site.include_file | append: '.html' }} %}"
    When I run jekyll build
    Then the _site directory should exist
    And I should see "one included" in "_site/index.php"
  ...
  Scenario: Include a file with partial variables
    ...
    | key          | value |
    | include_file | one   |
    And I have an "index.php" page that contains "{% include {{ site.include_file }}.html %}"
    When I run jekyll build
    Then the _site directory should exist
    And I should see "one included" in "_site/index.php"
