Feature: Fancy permalinks
  ...
  Scenario: Use pretty permalink schema
    ...
    When I run jekyll build
    Then the _site directory should exist
    And I should see "Totally wordpress." in "_site/2009/03/27/pretty-permalink-schema/index.php"

  Scenario: Use pretty permalink schema for pages
    Given I have an "index.php" page that contains "Totally index"
    ...
    When I run jekyll build
    Then the _site directory should exist
    And I should see "Totally index" in "_site/index.php"
    And I should see "Totally awesome" in "_site/awesome/index.php"
  ...
  Scenario: Use custom permalink schema with prefix
    ...
    When I run jekyll build
    Then the _site directory should exist
    And I should see "Totally custom." in "_site/blog/2009/03/27/custom-permalink-schema/index.php"
  ...
  Scenario: Use per-post permalink
    ...
    And I should see "bla bla" in "_site/custom/posts/1/index.php"
